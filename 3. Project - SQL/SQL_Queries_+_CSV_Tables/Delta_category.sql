-- This query collects the top 100 and bot 100 movie categories sorted by their earnings and substracts them from each other to get the delta of how many movies are
